    ...
    if st.button('Analyze'):
        ...
        if function_option == 'Analyze Comments':
            ...
            for comment in comments:
                ...
                if 'Hate Speech' in hate_predictions:
                    st.image("C:/Users/samir/Detector de odio/Detector_de_odio_G1/src/streamlite_app/odio_face.jpeg", width=100)
                elif sentiment['label'] == 'POSITIVE':
                    st.image("C:/Users/samir/Detector de odio/Detector_de_odio_G1/src/streamlite_app/happy_face.jpeg", width=100)
                else:
                    st.image("C:/Users/samir/Detector de odio/Detector_de_odio_G1/src/streamlite_app/neutro_face.jpeg", width=100)
